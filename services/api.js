...
var URL = getEnv('API_BASE_URL');
var getDataFromServer = function (variable) { return __awaiter(void 0, void 0, void 0, function () {
    var url, response, data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                url = "".concat(URL, "globalGetServer?payload=").concat(variable);
            ...
            case 4:
                error_1 = _a.sent();
                return [2 /*return*/, 'Произошла ошибка при получении данных'];
...
function postDataServer(variableName, payload) {
    return __awaiter(this, void 0, void 0, function () {
        var url, response, data, responseData, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
                ...
                case 6:
                    error_2 = _a.sent();
                    return [2 /*return*/, 'Произошла ошибка при передаче данных'];
