...
const raiting_1 = require("./conversation/raiting/raiting");
...
bot.use((0, conversations_1.createConversation)(raiting_1.raiting, { maxMillisecondsToWait: oneHourInMilliseconds }));
